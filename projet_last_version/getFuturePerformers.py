...
duration_paths = {
    ...
    '3 minutes ago UTC' : '/home/tsereir/tsereir/projets/algorithmic_trading/data/topPerformers_C/3minutesFutures',
}
...
def get_top_performer_multithreading(client, interval, duration, n=10, futures=True):
    ...
    if duration in duration_paths:
        file_path = f"{duration_paths[duration]}\\top_performers_{date_str}.parquet"
...
def job():
    get_top_performer_multithreading(client, '1m',  '3 minutes ago UTC', n=1)
